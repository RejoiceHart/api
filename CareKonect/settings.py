"""
Django settings for CareKonect project.
...
SECRET_KEY = 'django-insecure-m!f5=cq&nfr1lhl04e%tn^ypmx)jycd#_*%)12%le%^&vxnnng'
...
WSGI_APPLICATION = 'CareKonect.wsgi.application'
